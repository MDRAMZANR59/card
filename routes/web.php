...
//amount
Route::get('admin/amount',[AmountController::class,'index'])->name('amount');
Route::get('amount/create',[AmountController::class,'create'])->name('amount.create');
Route::post('amount/store',[AmountController::class,'store'])->name('amount.store');
Route::get('amount/edit/{id}',[AmountController::class,'edit'])->name('amount.edit');
Route::post('amount/update/{id}',[AmountController::class,'update'])->name('amount.update');
Route::post('amount/delete/{id}',[AmountController::class,'delete'])->name('amount.delete');

//card
Route::get('admin/card',[CardController::class,'index'])->name('card');
